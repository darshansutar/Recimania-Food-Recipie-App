...
public class InstructionsAdapter extends RecyclerView.Adapter<InstructionsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull InstructionsViewHolder holder, int position) {
            ...
            InstructionsStepsAdapter instructionsStepsAdapter = new InstructionsStepsAdapter(context,list.get(position).steps);
            holder.recycler_instruction_steps.setAdapter(instructionsStepsAdapter);
    }
