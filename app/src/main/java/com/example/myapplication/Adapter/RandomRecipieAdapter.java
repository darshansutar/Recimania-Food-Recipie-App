...
public class RandomRecipieAdapter extends RecyclerView.Adapter<RandomRecipieViewHolder> {
    ...
    public RandomRecipieAdapter(Context context, List<Recipe> list,RecipieClickListener listener) {
    ...
    public RandomRecipieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new RandomRecipieViewHolder(LayoutInflater.from(context).inflate(R.layout.list_random_recipie,parent,false));
    }
