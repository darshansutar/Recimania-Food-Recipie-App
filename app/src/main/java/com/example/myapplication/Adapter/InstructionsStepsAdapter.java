...
public class InstructionsStepsAdapter extends RecyclerView.Adapter<InstructionStepViewHolder> {
    ...
    public void onBindViewHolder(@NonNull InstructionStepViewHolder holder, int position) {
            ...
            InstructionsIngridentsAdapter instructionsIngridentsAdapter = new InstructionsIngridentsAdapter(context,list.get(position).ingredients);
            holder.recycler_instructions_ingridients.setAdapter(instructionsIngridentsAdapter);
...
class InstructionStepViewHolder extends RecyclerView.ViewHolder{
    ...
    public InstructionStepViewHolder(@NonNull View itemView) {
        ...
        textView_instruction_step_number = itemView.findViewById(R.id.textView_instructions_step_number);
        textView_instruction_step_title = itemView.findViewById(R.id.textView_instructions_step_title);
        recycler_instructions_equipments = itemView.findViewById(R.id.recycler_instruction_equipments);
        recycler_instructions_ingridients = itemView.findViewById(R.id.recycler_instruction_ingridients);
    }
}
